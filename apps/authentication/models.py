...
class Comuna(models.Model):
    id_region = models.ForeignKey(Region, on_delete=models.CASCADE, db_column='region_id')
...
class Empleados(models.Model):
    ...
    id_region = models.ForeignKey(Region, on_delete=models.CASCADE, db_column='id_region_id') 
    id_comuna = models.ForeignKey(Comuna, on_delete=models.CASCADE, db_column='id_comuna_id')
